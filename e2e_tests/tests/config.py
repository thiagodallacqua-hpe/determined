...
DEFAULT_TF1_CPU_IMAGE = "determinedai/environments-dev:py-3.7-pytorch-1.7-tf-1.15-cpu-ca75ad6"
DEFAULT_TF2_CPU_IMAGE = (
    "determinedai/environments-dev:py-3.8-pytorch-1.10-lightning-1.5-tf-2.8-cpu-ca75ad6"
)
DEFAULT_TF1_GPU_IMAGE = "determinedai/environments-dev:cuda-10.2-pytorch-1.7-tf-1.15-gpu-ca75ad6"
DEFAULT_TF2_GPU_IMAGE = (
    "determinedai/environments-dev:cuda-11.3-pytorch-1.10-lightning-1.5-tf-2.8-gpu-ca75ad6"
)
